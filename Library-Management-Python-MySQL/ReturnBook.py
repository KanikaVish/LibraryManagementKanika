...
def returnn():
    ...
    bid = bookInfo1.get()
    allBid.clear()  # Ensure allBid is cleared before fetching new IDs
    ...
    try:
        ...
        print("Fetched Book IDs:", allBid)  # Debug: Print fetched book IDs
        ...
        if bid in allBid:
            ...
            status = False  # Ensure status is set to a default value
    ...
    try:
        ...
        messagebox.showinfo("Search Error", f"The value entered is wrong, Try again: {e}")
